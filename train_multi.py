...
parser.add_argument('--total_step', type=int, default=5000, help='총 학습 스텝 수') 
...
parser.add_argument('--eval_every', type=int, default=150, help='몇 step마다 평가할건지') 
        ...
        if global_step % EVAL_EVERY == 0:
            ...
            if valid_loss < minimum_loss: 
                ...
                if accelerator.is_main_process:
                    ...
                    accelerator.print(f"global_step: {global_step}, model saved") 
        else:
